            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title text-bold">View Feedback</h3>
                        ...
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                if(isset($_GET['search']))
                                {
                                    ...
                                    $searchQuery = "SELECT * FROM feedback f inner join customer c on f.Customer_cus_id = c.cus_id WHERE CONCAT(feedback_note,feedback_id,cus_name) like '%$search%'";
                                    $result_search = mysqli_query($con,$searchQuery);
                                    foreach($result_search as $row)
                                    {
                                        $id = $row['feedback_id'];
                                        $des = $row['feedback_note'];
                                        $name = $row['cus_name'];   
                                    ?>
                                    <tr>
                                ...
                                $fetch = "SELECT feedback.feedback_id,feedback.feedback_note,customer.cus_name FROM feedback INNER JOIN customer ON feedback.Customer_cus_id = customer.cus_id";
