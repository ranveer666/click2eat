                               ...
                               if(isset($_GET['order_id']))
                                     {
                                         ...
                                         mysqli_query($con,"UPDATE orders set order_status='$status' where order_id='$id'");
                                     }
                                if(isset($_GET['search']))
                                {
                                    ...
                                    $searchQuery =  "SELECT order_id, order_date,total_amt, cus_name, cus_mo_no,order_status
                                    ...
                                    <tr>
                                        ...
                                        if($row['order_status']==0){
                                            echo "<a href='?order_id=".$id."&type=deactive' class='badge bg-danger'>New</a>";
                                        }else{
                                        echo "<a href='?order_id=".$id."&type=active' class='badge bg-danger'>Prepared</a>";
                                          }
                                       ?>
                                        </td>
                                        <td>
                                            <a href="edit_new_order.php?order_id=<?php echo $id?>" class="">
                                ...
                                {
                                $fetch = "SELECT order_id, order_date,total_amt, cus_name, cus_mo_no ,order_status
                                FROM orders o  join customer c on o.Customer_cus_id = c.cus_id where order_status='0'";
                                ...
                                ?>
                                    ...
                                    <tr>
                                       ...
                                       ?>
                                        ...
                                        <td>
                                            <a href="view_new_order.php?order_id=<?php echo $id?>" class="">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="./code.php?order_id=<?php echo $id ?>" class="deleteUsers"
                                                onclick="return confirmDelete()">
